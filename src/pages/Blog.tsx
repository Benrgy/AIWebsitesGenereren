...
const blogPosts = [
  {
    ...
    tips: [
      ...
      "Optimaliseer afbeeldingen voor web (WebP formaat)",
      "Zorg voor proper caching headers",
      "Minimaliseer CSS en HTML bestanden"
    ]
  },
  {
    id: 2,
    ...
    icon: Target,
    content: [
      "Lokale SEO is essentieel voor bedrijven die klanten in een specifiek gebied willen bereiken. Door unieke landingspagina's te maken voor elke stad of regio, vergroot je je zichtbaarheid aanzienlijk.",
      "De sleutel is het creëren van relevante, unieke content voor elke locatie. Kopieer niet simpelweg dezelfde tekst met een andere plaatsnaam - Google herkent dit en bestraft duplicate content.",
      "Met AI-gegenereerde variaties kun je snel tientallen unieke pagina's maken, elk geoptimaliseerd voor een specifieke zoekterm en locatie."
    ],
    tips: [
      "Gebruik '[dienst] + [plaatsnaam]' als primair keyword",
      "Voeg lokale bedrijfsgegevens toe (NAP consistency)",
      "Maak unieke meta descriptions per pagina",
      "Integreer Google Maps indien relevant"
    ]
  },
  {
    id: 3,
    ...
    tips: [
      ...
      "Creëer waardevolle content, niet alleen promotie",
      "Test verschillende call-to-actions per pagina",
      "Monitor je rankings en pas aan waar nodig"
    ]
  },
  {
    id: 4,
    ...
    tips: [
      ...
      "Definieer afbeelding dimensies in HTML",
      "Gebruik system fonts waar mogelijk"
    ]
  },
  {
    id: 5,
    ...
    icon: Zap,
    content: [
      "Effectieve keyword research is de basis van elke succesvolle SEO-campagne. Begin met tools zoals Google Keyword Planner, Ubersuggest, of Ahrefs om kansen te identificeren.",
      "Zoek naar keywords met decent zoekvolume maar lage concurrentie. Long-tail keywords zoals 'loodgieter amsterdam centrum' zijn vaak makkelijker te ranken dan generieke termen.",
      "Met onze bulk generator kun je direct meerdere variaties maken voor elk keyword. Koppel je Gitpage.site API key en je websites zijn binnen minuten live."
    ],
    tips: [
      "Gebruik Google Trends voor seizoensgebonden keywords",
      "Analyseer competitor websites voor content gaps",
      "Maak minimaal 5-10 variaties per keyword",
      "Track rankings vanaf dag 1 met Google Search Console"
    ]
  },
  {
    id: 6,
    ...
    tips: [
      "Custom domains verbeteren merkherkenning en SEO",
      "SSL is verplicht voor Google rankings",
      "CDN zorgt voor consistente laadtijden wereldwijd",
      "Git-based workflow maakt versioning eenvoudig"
    ]
  }
];
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <Card key={post.id} className="flex flex-col h-full hover:shadow-lg transition-shadow border-border">
                <CardHeader>
